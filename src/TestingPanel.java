...
public class TestingPanel extends JFrame implements ActionListener, ChangeListener, MouseListener{
	...
	public void InitializeObjects() {
		...
		//Texts
		trainingPanelText = new JLabel("Testing Panel");
...
//			slider[x].setMinorTickSpacing(5);
	...
	public void SetDesign() {	
		...
		//Texts
		trainingPanelText.setForeground(Color.ORANGE);
...
//		scrollPane.getVerticalScrollBar().setUI(new BasicScrollBarUI() );
		...
		//Fonts
			//fonts Texts
			trainingPanelText.setFont(bigFont);
...
//			deleteTrainingButton.setFont(f2);
	...
	public void SetPosition() {
		...
		//Texts
		trainingPanelText.setBounds(580, 0, 250, 50);
...
//			this.setVisible(false);
	...
	//Training---------------------------------------------------------------------------
	public void Training(String _word) {
		String emotionData = slider[0].getValue() + "\t" + slider[1].getValue() + "\t" + slider[2].getValue()
								+ "\t" + slider[3].getValue() + "\t" + slider[4].getValue();
		
		fileManager.EnterData(_word, emotionData);
		//Clearing Words
		ClearWords();
		//BS CONSOLE
		consoleWordsArea.setText("Removing Stop Words - 100%\nRecognizing Words - 100%\nFiltering Unrecognized Words - 100%\nTraining Complete...");
